...
BASE = r"c:\Escritorio\Pagina Web\velqia"

files = {}

files["app/escapadas/EscapasClient.tsx"] = """\
'use client'
    ...
    <footer className="bg-brand text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-sm text-slate-300">Escapadas y viajes sin coche desde España.</p>
        </div>
        <div>
...
files["components/home/QuickFilters.tsx"] = """\
'use client'
...
files["components/home/FeaturedEscapes.tsx"] = """\
import Link from 'next/link'
import Image from 'next/image'
import { MapPin, ArrowRight } from 'lucide-react'
import { escapes } from '@/data/escapes'
...
files["components/home/ValueBlock.tsx"] = """\
...
files["components/home/SeoBlock.tsx"] = """\
...
files["components/escapes/EscapeCard.tsx"] = """\
import Link from 'next/link'
import Image from 'next/image'
import { MapPin, ArrowRight } from 'lucide-react'
...
files["components/escapes/FilterSidebar.tsx"] = """\
'use client'
...
files["components/escapes/SortBar.tsx"] = """\
'use client'
...
files["components/detail/EscapeDetailHero.tsx"] = """\
import Image from 'next/image'
...
files["components/detail/QuickFacts.tsx"] = """\
import type { Escape } from '@/types'
...
files["components/detail/CTASection.tsx"] = """\
import Link from 'next/link'
...
for rel_path, content in files.items():
    ...
    with open(full_path, "w", encoding="utf-8") as f:
        f.write(content)
    lines = content.count("\n") + 1
    print(f"OK {rel_path}: {lines} lines")
